...
class BloqueDeLibros
{
    ...
    public void AnyadirLibro()
    {
        ...
        if (opcion == "1")
        {
            ...
            libros[contador] = new Libro(titulo, autor, ubicacion, paginas);
            contador++;
        ...
        if (opcion == "2")
        {
            ...
            libros[contador] = new Articulo(titulo, autor, ubicacion, procedencia);
            contador++;
        }
    ...
    public void ModificarLibro()
    {
        ...
        procedencia = Console.ReadLine();
        libros[numero - 1] = new Libro(titulo, autor, ubicacion, paginas);
    }
